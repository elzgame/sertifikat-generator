...
$nama           = $r_tampil_perserta['nama'];
$no_sertifikat  = $r_tampil_perserta['nosertifikat'];
$kategori       = $r_tampil_perserta['kategori'];
$tema           = $r_tampil_perserta['tema'];
...
<div class='card p-3 bg-white'>
    <div class='card-body bg-white' style='background-color: #e5e5f7; opacity: 1; background-size: 10px 10px;background-image: repeating-linear-gradient(45deg, #444cf7 0, #444cf7 1px, #e5e5f7 0, #e5e5f7 100%);border: 2px solid black; border-radius: 10pxs;'>
        ...
        <p> Atas peran serta sebagai <b> $kategori</b> dalam kegiatan Webinar dengan tema '<i> $tema</i>' yang diselenggarakan pada 25 Agustus 2021, dalam kurun waktu 4 (empat) jam pertemuan yang diselenggarakan oleh Pusat Penelitian dan Pengabdian kepada Masyarakat (P3M) Politeknik Negeri Cilacap. </p>
        <center>
